...
In this case there were many substitutions which fully segregates between clusters 1 and 3 (>0.999). however, as there is only one PBP-type in cluster 3, and there were relatively few isolates of this PBP-type (<5) these substitutions were marked as weak evidence only.
...
# Summary
In total, 77 PBP locations were  associated with the phenotypic cluster differences in this subset of isolates, although only 6 had strong evidence of generating an effect All 6 were located in the PBP2x protein. 
