...
In this second comparison, there was a difference between clusters 1 and 3 at several amino acid positions. However, these were only marked as having 'weak' evidence, because cluster 3 only had a single PBP-type and this was only represented by 3 isolates, which had highly divergent phenotypes. 
...
In this third comparison, there was a difference between clusters 2 and 3 at several amino acid positions. However, these were again only marked as having 'weak' evidence, because as above, cluster 3 only had a single PBP-type and this was only represented by 3 isolates, which had highly divergent phenotypes. 
...
# Summary
In total, 27 PBP locations were weakly associated with the phenotypic cluster differences in this subset of isolates.  
