...
In this example, there are several positions which differentiate clusters 1 and 2. This is a difficult case as to what to mark them, as though they are strongly differentiated, cluster 1 has only 1 PBP-type and cluster 2 has only three. This would not be such as a problem, if not for the fact that the three PBP-types of cluster 2 only have one isolate each, and so there is not much confidence that this represents their actual position on the map. Because of this, I have marked these positions as weak evidence only. However, notably, PBP2X I371T comes out here and also strongly below for the comparison between clusters 1 and 3.
...
In this last comparison, there was a clear difference in four amino acid positions between clusters 3 and 4. Notably, there was also another position PBP2X M400, which was also strongly associated, but not 100%. This position also came out above in the cluster 2-4 comparison. I made a note of this position for combination into the final table as having weak evidence.
...
# Summary
In total, 15 PBP locations were associated with the phenotypic cluster differences in this subset of isolates. 
