...
In this last comparison, there was a clear difference in amino acid at many positions between clusters 2 and 3. However, in this case, there were only 2 PBP-types in cluster 2, and each of these were only represented by a single isolate. Moreover, the distribution of the next most segregated amino acid positions were only around 50%. Taken together this suggests these amino acids are not being picked out simply as an artefact of the method, and so were not marked as weak or strong evidence. 
...
# Summary
In total, 13 PBP locations were weakly associated with the phenotypic cluster differences in this subset of isolates. All 9 of these 13 were located in the PBP2b protein, while the remained were located in the 2x protein. 
