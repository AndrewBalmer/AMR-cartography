...
Below is an example of this method. In this case there are no substitutions which clearly segregate between the two clusters. Though there does appearto be a phenotypic difference between the isolates of the two clusters, there are only 5 PBP-types in cluster 1, and each of these only have 1 isolate each. This may suggest there is limited confidence in their relative position. It is therefore not possible to mark any of these substitutions as having evidence in generating a phenotypic effect.
