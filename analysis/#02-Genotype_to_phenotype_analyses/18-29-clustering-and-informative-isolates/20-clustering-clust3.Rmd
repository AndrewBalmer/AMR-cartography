...
In this case there is 1 substitution which partially segregates between clusters 1 and 3 (>0.80). However, as it does not segregate fully, it is only marked as 'weak' evidence.
...
# Summary
In total, 2 PBP locations were strongly associated with the phenotypic cluster differences in this subset of isolates. 
