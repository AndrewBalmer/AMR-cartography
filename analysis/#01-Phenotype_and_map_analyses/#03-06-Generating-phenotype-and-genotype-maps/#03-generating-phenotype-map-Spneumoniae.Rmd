...
setwd("/Users/ajb306/AMR-cartography/analysis/#01-Phenotype_and_map_analyses/#03-06-Generating-phenotype-and-genotype-maps/results")
...
# Generate a distance matrix for a subset of samples (for speed of use)
#dist_pne <- dist(slice_sample(tablemic, n = 200))

# However, if you would like to run the full analysis, use this line which reads in the full dist matrix
