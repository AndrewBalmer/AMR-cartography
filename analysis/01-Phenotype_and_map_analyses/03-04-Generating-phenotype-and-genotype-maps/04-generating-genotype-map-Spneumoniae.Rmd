...
set.seed(1234)  # reproducibility for the random-start MDS below (finding #4)
...
#load(amrc_data_path("tablemic_pneumo_3628_meta_gen_distance_matrix_200_subsample.RData"))
