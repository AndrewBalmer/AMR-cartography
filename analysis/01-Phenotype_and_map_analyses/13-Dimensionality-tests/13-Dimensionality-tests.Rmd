...
one_dim_map <- as_tibble(torg_met$conf)
...
ggsave("Spneumo_phen_1D_procrustes_projection.jpg")
...
B <- ggplot(filter(one_two_dim_comp), aes(x=spp_1D)) + 
  geom_histogram(position="identity", alpha = 0.6, fill = "#E41A1C", color = "black", bins = 25) + 
  theme_bw() + 
...
ggsave("Spneumo_phen_1D_procrustes_projection_distances.jpg")
